...
fallouts, recalls = loadFalloutsAndRecallsFromFile('FalloutsAndRecallsWith karolisTrial scikit10000 auc 0.727736869701.csv')
plotROC(fallouts, recalls, shouldShow = True , aucstr = 'karolisTrial scikit10000 auc 0.727736869701')

fallouts, recalls = loadFalloutsAndRecallsFromFile('FalloutsAndRecallsWith karolisTrial scikit100 auc 0.720728025427.csv')
plotROC(fallouts, recalls, shouldShow = True , aucstr = 'karolisTrial scikit100 auc 0.720728025427.csv')

fallouts, recalls = loadFalloutsAndRecallsFromFile('FalloutsAndRecallsWith karolisTrial karolis1000000 auc 0.711358648947.csv')
plotROC(fallouts, recalls, shouldShow = True , aucstr = 'karolisTrial karolis1000000 auc 0.711358648947.csv')

fallouts, recalls = loadFalloutsAndRecallsFromFile('FalloutsAndRecallsWith karolisTrial karolis10000 auc 0.711358648947.csv')
plotROC(fallouts, recalls, shouldShow = True , aucstr = 'karolisTrial karolis10000 auc 0.711358648947.csv')
